...
// NOTE: TestDebugSite and LoginTargetSite are coupled enums. Adding a third site
// requires updating both independently plus SettingVariationGenerator.generateSessions().
...
nonisolated enum TestDebugVariationMode: String, CaseIterable, Sendable {
    ...
    case sitchomatic1000 = "Rinseomatic1000 1000"
...
nonisolated struct TestDebugSettingsSnapshot: Sendable {
    ...
    // tabBetweenFields is derived — always set to (pattern == "Tab Navigation"), not independently configurable
    ...
    var multiplexTarget: ProxyRotationService.ProxyTarget? = nil // Rinseomatic1000 1000 Routing

...
class DebugLogger {
    ...
    var automationOnlyMode: Bool {
        get { UserDefaults.standard.bool(forKey: "debug_automation_only_mode") }
        set {
            UserDefaults.standard.set(newValue, forKey: "debug_automation_only_mode")
            if newValue {
                enabledCategories = DebugLogCategory.automationOnlySet
            } else {
    ...
    init() {
        if UserDefaults.standard.bool(forKey: "debug_automation_only_mode") {
            enabledCategories = DebugLogCategory.automationOnlySet
        }
        startAutoPersist()
    }

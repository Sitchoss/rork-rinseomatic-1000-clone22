...
// SettingVariationGenerator intentionally defines its own variation arrays
// (typingSpeeds, patterns, delays, etc.) as internal constants rather than
// reading them from AutomationSettings. This is by design — the generator
// explores a fixed matrix of known-good test combinations, not the live
// user-configured values. Do not replace these with AutomationSettings reads.
class SettingVariationGenerator {
    ...
    // MARK: - Rinseomatic1000 1000 Multiplex Feature

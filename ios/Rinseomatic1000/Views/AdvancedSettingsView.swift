                ...
                Toggle(isOn: $automationOnlyMode) {
                    HStack(spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            Text("Automation Events Only").font(.subheadline.bold())
                            Text("Silence all logging except automation")
            ...
            Section {
                Button {
                    ...
                    settingsRow(
                        ...
                        subtitle: "Full script debug report to clipboard — paste to Rork",
                        color: .indigo
                    )
                }
                ...
                Button {
                    ...
                    settingsRow(
                        ...
                        subtitle: "Export as .txt for sending back to Rork for fixes",
                        color: .indigo
                    )
                }
            } header: {
                Label("Automation Script Diagnostics", systemImage: "stethoscope")
            } footer: {
                Text("Generates the most detailed possible automation report — settings, selectors, per-session timelines, error chains, pattern logs, and healing history. Designed to paste directly to Rork for script fixes.")
            }
        }
    }

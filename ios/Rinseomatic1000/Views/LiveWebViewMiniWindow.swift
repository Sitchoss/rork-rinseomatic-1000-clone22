...
struct LiveWebViewMiniWindow: View {
    ...
    private enum SizePreset: CaseIterable {
        ...
        var size: CGSize {
            switch self {
            case .small: CGSize(width: 144, height: 144)
            case .medium: CGSize(width: 192, height: 192)
            case .large: CGSize(width: 264, height: 264)
            }
        }
                    ...
                    RoundedRectangle(cornerRadius: 14)
                        ...
                        .overlay {
                            LiveWebViewContainerView(webView: webView, interactive: false)
                                .scaleEffect(debugService.previewScale)
    ...
    private var siteToggleBadge: some View {
        VStack {
            HStack {
                Spacer()
                Button {
                    ...
                    .padding(.horizontal, 6)
                    .padding(.vertical, 3)
                    .background(debugService.activeSite == .joe ? Color.blue.opacity(0.8) : Color.orange.opacity(0.8))
                    .clipShape(Capsule())
                }
                .padding(.trailing, 6)
                .padding(.top, 26)

...
struct LoginDashboardContentView: View {
    ...
    private var accentColor: Color { vm.urlRotation.isIgnitionMode ? .orange : .green }
        ...
        HStack(spacing: 10) {
            Button {
                ...
                VStack(spacing: 4) {
                    ...
                    if vm.untestedCredentials.isEmpty && !vm.isRunning {
                        Text("Import credentials first")
                            .font(.system(.caption2, design: .monospaced))
                ...
                .padding(.vertical, 12)
                .background(vm.isRunning || vm.untestedCredentials.isEmpty ? accentColor.opacity(0.3) : accentColor)
